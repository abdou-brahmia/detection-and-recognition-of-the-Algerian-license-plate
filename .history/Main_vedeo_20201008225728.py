...
import modules.gestion_bdd.Main as gestion_bddQtCore
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow,w,h):
        ...
        self.type_bdd=1
        self.typecolor=1
        video='./Vedeo/test2.mov'  #change it to test1.mov to use the other vedeo
            ...
            if detection_car_result[0]==True:
                ...
                if state[0]==True:
                    ...
                    if (self.checkBox_6.isChecked()):
                        cv2.putText(self.image_after_processing,s,(local_mat [0] +valx , local_mat [1] -20+valy ), font, 1,SCALAR_RED,2)
                    else:
                        cv2.putText(self.image_after_processing,"detected",(local_mat [0] +valx , local_mat [1] -20+valy ), font, 1,SCALAR_RED,2)
                    
                    if (self.checkBox_6.isChecked()):
                        cv2.rectangle(self.image_after_processing
                            ,(local_mat [0] -5 +valx , local_mat [1] -5+valy )     
